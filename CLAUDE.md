...
│   └── victims/                 # 4,375 victim YAML files + template
...
| Victims | 4,375 | `data/victims/{year}/slug.yaml` |

**Victims:** 4,375 YAML files across 5 sources (Wikipedia, HRANA, IHR, iranvictims.com, manual). Fully deduplicated via `scripts/dedup_victims.py` (206 duplicates removed in 3 rounds). 28 SKIP pairs confirmed as different people.
